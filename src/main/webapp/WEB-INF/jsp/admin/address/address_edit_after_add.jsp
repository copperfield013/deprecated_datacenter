...
<div id="address-edit-after-add">
	...
	<div class="page-body">
		<div class="row">
			<div class="col-lg-12">
				<form id="address-edit-after-add-form" class="bv-form form-horizontal validate-form" action="admin/address/doEdit">
						...
						<div>
							...
							<div class="col-lg-8">
								<c:forEach items="${list }" var="addressElement" varStatus="i">
									...
									<input type="text" class="form-control" name="elements[${i.index }].termWord" value="${addressElement.termWord }" style="display:inline-block; width: 10%;"style="display:inline-block; width: 10%;"/>
