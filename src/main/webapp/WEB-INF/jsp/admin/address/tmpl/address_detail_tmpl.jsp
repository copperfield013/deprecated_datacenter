...
<div class="detail peopledata-detail-tmpl" id="peopledata-detail-tmpl-${code }">
...
<script>
	seajs.use(['dialog', 'ajax', 'utils', 'peopledata/js/viewtmpl-update.js', '$CPF'], function(Dialog, Ajax, Utils, ViewTmpl, $CPF){
		var $page = $('#peopledata-detail-tmpl-${code }');
		...
		$page.on('click', '.circ', function(){
			...
			$page.getLocatePage().loadContent('admin/peopledata/detail_tmpl/${code}?tmplId=${tmpl.tmplId}', null, {timestamp:time});
