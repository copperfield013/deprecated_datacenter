...
<div id="demo-add">
	...
	<div class="page-body">
		<div class="row">
			<div class="col-lg-12">
				<form class="bv-form form-horizontal validate-form" action="admin/people/do_add">
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input name="gender" id="1" type="radio" value="" style="opacity:1;position: static;height:13px;"/> 
							<label for="1">男</label> 
							<input name="gender" id="0" type="radio" value="" style="opacity:1;position: static;height:13px;"/> 
							<label for="0">女</label> 
						</div>
					</div>
					<div class="form-group">
...
<script>
	...
	$("#contact").blur(function(){
		...
		if(!isPhone.test(contact)||!isMob.test(contact)){//座机、手机验证
			alert('联系电话有误，请重填');
			return false;
			}
	});
