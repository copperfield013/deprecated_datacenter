			...
			<div class="col-lg-12">
				<form id="integratedForm" class="bv-form form-horizontal validate-form search"action="admin/peopledata/do_update">
					...
					<div class="form-group">
						...
						<div class="col-lg-4">
							<input name="gender" id="1" type="radio" value="1" style="opacity:1;position: static;height:13px;" ${people.gender=='男性'? 'checked':'' }/>
							<label for="1">男性</label>
							<input name="gender" id="2" type="radio" value="2" style="opacity:1;position: static;height:13px;" ${people.gender=='女性'? 'checked':'' }/>
 ...
 * **/
	...
	//查询  如果已经查询过则不再查询
		...
		$("#smartSubmit",$page).on("click",function(){
            ...
            Ajax.ajax('admin/peopledata/smart_search',{
                peopleCode : peopleCode,
                type:type,
                field:SearchWordEnglish                     //name  后期改为SearchWordEnglish
            },function(json) {
                addSmartSerarch(json,SearchWord,SearchWordEnglish,peopleCode,$page,type,check_rule);
            });
        });
