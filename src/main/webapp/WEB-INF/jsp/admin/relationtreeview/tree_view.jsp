		...
		<div class="row">
			...
			seajs.use(['ajax', 'dialog'], function(Ajax, Dialog){
				...
				function initTree(parentId, mappingName){
					Ajax.ajax("admin/relationtreeview/data", {
						code	:	parentId,
				...
				*/
				$("#add-node-btn", $page).on('click', function(){
					...
					console.log(id);
					Dialog.openDialog("admin/relationtreeview/add?type=relation&mappingName=" + mappingName + "&id=" + id +"&rootId=${id}","添加关系节点", "add-tree-relation-node",{
						width	: 600,
						height	: 400
					});
				});
				...
				*/
				$("#edit-node-btn", $page).on('click', function(){
					...
					Dialog.openDialog("admin/relationtreeview/edit?mappingName=" + mappingName + "&id=" + id + "&rootId=${id}", "编辑关系节点", "edit-tree-relation-node",{
						width	: 600,
						height	: 400
					});
				});
				...
				*/
				$("#remove-node-btn", $page).on('click', function(){
					...
					getChildrenNode	console.log("选中的节点是：" + nodes);
					Dialog.confirm('确认删除节点？', function(yes){
						if(yes){
							Ajax.ajax("admin/relationtreeview/delete", {
				...
				$page.data("addSubmit", function(mapJson){
					...
					Ajax.ajax("admin/relationtreeview/saveNode", {
						mappingName	:	mappingName,
